...
<head>
    ...
    <title>DINSOS PM - Pemberdayaan Sosial</title>
...
<div class="main-content">
        ...
        <div class="container-fluid">
            ...
            <div class="account-dropdown">
                <button class="btn account-btn d-flex align-items-center">
                    ...
                    <h6 class="mb-0">Hallo, Staff Pemberdayaan Sosial</h6>
                </button>
                <div class="dropdown-content">
                    <div class="d-flex align-items-center p-2">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-muted small">Pemberdayaan Sosial</p>
                        </div>
                    </div>
                    <hr class="my-2">
    ...
    <div class="content-wrapper">
        ...
        <!-- Tombol Input -->
                <?php if ($_SESSION['role'] === 'Pemberdayaan Sosial'): ?>
                    <div class="text-start mb-1">
                        <a class="btn btn-success" href="editpemberdayaan.php">
                ...
                <?php  else: ?>
                    <div class="text-start mb-1">
                        <p class=" text-muted"><i class="bi bi-info-circle-fill"></i> Hanya bisa di akses staff Pemberdayaan Sosial</p>
                    </div>
                <?php endif; ?>
    ...
    <div class="card-body">
        <form method="GET" action="" class="row g-3 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-3 align-items-end">
                ...
                <a href="pemberdayaan.php" class="btn btn-outline-success btn-filter">
        ...
        <div class="modal-content">
            ...
            <?php if ($_SESSION['role'] === 'Pemberdayaan Sosial'): ?>
                    <div class="modal-footer">
                        <a href="editpemberdayaan.php?indikator_id=<?= $id; ?>&tahun=<?= $tahun; ?>" class="btn btn-success px-4">
...
function confirmDelete(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data realisasi ini?')) {
        window.location.href = 'pemberdayaan.php?delete=' + id;
    }
}
