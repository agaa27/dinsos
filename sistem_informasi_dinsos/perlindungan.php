...
<head>
    ...
    <title>DINSOS PM - Perlindungan dan Jaminan Sosial</title>
...
<div class="main-content">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary text-white">
        <div class="container-fluid">
            <h5 class="mb-0">Perlindungan dan Jaminan Sosial</h5>
    ...
    <div class="content-wrapper">
        ...
        <!-- Tombol Input -->
                <?php if ($_SESSION['role'] === 'Perlindungan dan Jaminan Sosial'): ?>
                    <div class="text-start mb-1">
                        <a class="btn btn-primary" href="editPerlindungan.php">
                ...
                <?php  else: ?>
                    <div class="text-start mb-1">
                        <p class=" text-muted"><i class="bi bi-info-circle-fill"></i> Hanya bisa di akses staff Perlindungan dan Jaminan Sosial</p>
                    </div>
                <?php endif; ?>
    ...
    <div class="card-body">
        <form method="GET" action="" class="row g-3 align-items-end">
            ...
            <div class="col-md-3 d-flex gap-3 align-items-end">
                ...
                <a href="perlindungan.php" class="btn btn-outline-success btn-filter">
        ...
        <div class="modal-content">
            ...
            <?php if ($_SESSION['role'] === 'Perlindungan dan Jaminan Sosial'): ?>
                    <div class="modal-footer">
                        <a href="editPerlindungan.php?indikator_id=<?= $id; ?>&tahun=<?= $tahun; ?>" class="btn btn-success px-4">
...
function confirmDelete(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data realisasi ini?')) {
        window.location.href = 'perlindungan.php?delete=' + id;
    }
}
